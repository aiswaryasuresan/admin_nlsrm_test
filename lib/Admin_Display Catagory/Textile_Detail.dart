                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Center(
                              child: GestureDetector(
                                onTap: () async => !await launch('sms:' + widget.list[widget.index]['phone']),
                                child: Text(
                    ...
                    Column(
                      children: [
                        ...
                        Container(
                          ...
                          child: Center(
                              child: GestureDetector(
                                onTap: () async => !await launch('sms:' + widget.list[widget.index]['mobile']),
                                child: Text(
                ...
                Padding(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () => MapsLauncher.launchQuery(
                        widget.list[widget.index]['name'] + widget.list[widget.index]['address']),
