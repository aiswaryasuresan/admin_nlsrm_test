...
import 'package:flutter_app_nileswaram_test/Update/Update_Restaurant.dart';
...
class Restaurant_Detail extends StatefulWidget {
  List list;
  int index;
  Restaurant_Detail({required this.index,required this.list});
...
class _Restaurant_DetailState extends State<Restaurant_Detail> {
  ...
  void deleteData(){
    ...
    var url= "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Delete/Restaurant_Delete.php";
          ...
          actions: [
            ...
            IconButton(
              ...
              onPressed: () {
                Navigator.of(context).push(
                  MaterialPageRoute(
                    builder: (BuildContext context)=>Restaurant_Update(list: widget.list, index: widget.index,),
                  ), );
              },
            ),
          ],
