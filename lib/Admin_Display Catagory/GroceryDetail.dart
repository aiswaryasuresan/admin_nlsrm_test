...
import '../Update/Update_Grocery.dart';

class GroceryDetail extends StatefulWidget {
  List list;
  int index;
  GroceryDetail({required this.index,required this.list});
...
class _GroceryDetailState extends State<GroceryDetail> {
  ...
  void deleteData(){
    ...
    var url= "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Delete/Grocery_Delete.php";
          ...
          actions: [
            ...
            IconButton(
              ...
              onPressed: () {
                Navigator.of(context).push(
                  MaterialPageRoute(
                    builder: (BuildContext context)=>Grocery_Update(list: widget.list, index: widget.index,),
                  ), );
              },
            ),
          ],
