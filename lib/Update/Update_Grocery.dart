...
class Grocery_Update extends StatefulWidget {
  final List list;
  final int index;

  Grocery_Update({required this.list, required this.index});

  @override
  _Grocery_UpdateState createState() => new _Grocery_UpdateState();
}

class _Grocery_UpdateState extends State<Grocery_Update> {
  ...
  void UpdateData() {
    var url ="https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Update/Grocery_Update.php";
